...
const ReceiptVoucher = () => {
  ...
  //   Currencies_value: Yup.string().required('Required'),
                      ...
                      <FormControl fullWidth>
                        <TextField
                          ...
                          onChange={event => {
                            ...
                            handleChange(event)
                            if (values.currency_value !== '' && values.currency_value !== 0) {
                              setFieldValue('amount', Number(amount_currency * values.currency_value).toFixed(2))
                              setFieldValue('table_total', Number(amount_currency * values.currency_value).toFixed(2))
                            } else {
                      ...
                      <FormControl fullWidth>
                        ...
                        <Select
                          ...
                          onChange={event => {
                            ...
                            setFieldValue('amount_currency', Number(values.amount / currency_value).toFixed(2))
                          }}
                          onBlur={handleBlur}
                          ...
                          onChange={event => {
                            ...
                            if (changeCurrency === 0) {
                              ...
                              if (values.amount_currency !== '' && values.amount_currency !== 0) {
                                setFieldValue('amount', Number(currency_value * values.amount_currency).toFixed(2))
                                setFieldValue('table_total', Number(currency_value * values.amount_currency).toFixed(2))
                              } else {
