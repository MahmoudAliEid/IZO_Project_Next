  ...
  useEffect(() => {
    if (searchInfo.length === 1) {
      ...
      push({
        ...
        cost: itemToAdd.cost === 0 ? itemToAdd.all_units[0].list_price[0].price : itemToAdd.cost,
        line_store: '',
        product_id: itemToAdd.product_id,
        quantity: 1,
        price: itemToAdd.cost === 0 ? itemToAdd.all_units[0].list_price[0].price : itemToAdd.cost,
        unit: 1,
        store: '',
          ...
          if (newValue) {
            ...
            if (newValue.variation_id === 0) {
              ...
              if (matchingOptions.length > 1) {
                ...
                matchingOptions.forEach(item =>
                  push({
                    ...
                    cost: item.cost === 0 ? item.all_units[0].list_price[0].price : item.cost,
                    line_store: '',
                    product_id: item.product_id,
                    quantity: 1,
                    price: item.cost === 0 ? item.all_units[0].list_price[0].price : item.cost,
                    unit: 1,
                    store: '',
              ...
              push({
                ...
                cost: newValue.cost === 0 ? newValue.all_units[0].list_price[0].price : newValue.cost,
                line_store: '',
                product_id: newValue.product_id,
                quantity: 1,
                price: newValue.cost === 0 ? newValue.all_units[0].list_price[0].price : newValue.cost,
                unit: 1,
                store: '',
