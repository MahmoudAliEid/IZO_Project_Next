...
const SalePriceGroup = ({ type, open, setOpen, itemId }) => {
  ...
  console.log(dataEditInfo, 'info of Sale Price Group')
  ...
  console.log(create, editInfo, 'Create form sale price group and edit info')
  ...
  return (
    ...
    >
      ...
      >
        <DialogContentText variant='body2' id='salePriceGroup-edit-add-description' sx={{ textAlign: 'center', mb: 7 }}>
