...
const columns = [
  ...
  },
  {
    flex: 0.2,
    minWidth: 140,
    field: 'Receipt Reference',
    headerName: 'Receipt Reference',
    renderCell: ({ row }) => (
      <Typography noWrap sx={{ color: 'text.secondary' }}>
        {row?.receipt_reference ? row.receipt_reference : 'Not available'}
      </Typography>
    )
  },
  {
  ...
  },
  {
    ...
    renderCell: ({ row }) => (
      <Typography noWrap sx={{ color: 'text.secondary' }}>
        {row?.supplier ? row.supplier : 'Not available'}
      </Typography>
    )
  },
  {
    ...
    renderCell: ({ row }) => (
      <Typography noWrap sx={{ color: 'text.secondary' }}>
        {row?.purchase_status ? row.purchase_status : 'Not available'}
      </Typography>
    )
  },
  {
    ...
    renderCell: ({ row }) => (
      <Typography noWrap sx={{ color: 'text.secondary' }}>
        {row?.payment_status ? row.payment_status : 'Not available'}
      </Typography>
    )
  },
  {
    flex: 0.2,
    minWidth: 140,
    field: 'Recieved status',
    headerName: 'Recieved status',
    renderCell: ({ row }) => (
      <Typography noWrap sx={{ color: 'text.secondary' }}>
        {row?.received_status ? row.received_status : 'Not available'}
      </Typography>
    )
  },
  {
    ...
    renderCell: ({ row }) => (
      <Typography noWrap sx={{ color: 'text.secondary' }}>
        {row?.warehouse_name ? row.warehouse_name : 'Not available'}
      </Typography>
    )
  },
  {
    ...
    renderCell: ({ row }) => (
      <Typography noWrap sx={{ color: 'text.secondary' }}>
        {row?.grand_total ? `${row.grand_total} AED` : 'No Data'}
      </Typography>
    )
  },
  {
    ...
    renderCell: ({ row }) => (
      <Typography noWrap sx={{ color: 'text.secondary' }}>
        {row?.payment_due ? `${row.payment_due} AED` : 'No Data'}
      </Typography>
    )
  },
  {
    ...
    renderCell: ({ row }) => (
      <Typography noWrap sx={{ color: 'text.secondary' }}>
        {row?.added_by ? row.added_by : 'Not available'}
      </Typography>
    )
  }
]
